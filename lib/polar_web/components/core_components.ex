defmodule PolarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PolarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PolarWeb.Gettext, "errors", msg, opts)
    end
  end
